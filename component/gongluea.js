...
class gongluea extends Component {
    render() {
        return (
            <ScrollView>
                <View style={styles.container} >
                    <View style={{ paddingTop: 80 * WH, paddingLeft: 100 * WW, paddingRight: 100 * WW }}>
                        ...
                        <View style={{ width: winWidth * 0.8, height: 800 * WH }}>
                            <VideoControls source={{ uri: "http://p7ik6bm59.bkt.clouddn.com/%E9%98%B2%E6%B4%AA%E7%BA%AA%E5%BF%B5%E5%A1%94.mp4" }}
                                disableBack={true}
                                disableTimer={true}
                                disableVolume={true}
                                showOnStart={false}
